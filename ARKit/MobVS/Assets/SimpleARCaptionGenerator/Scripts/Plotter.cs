...
namespace ARKitSDK.SimpleARCaptionGenerator {
	...
	/// <summary>
	/// This Script plots the letters for the caption model.
	/// </summary>
	public class Plotter : MonoBehaviour {
		...
		/// </summary>
		/// <param name="_name">The name value of the caption.</param>
		/// <param name="_position">The position value of the caption.</param>
